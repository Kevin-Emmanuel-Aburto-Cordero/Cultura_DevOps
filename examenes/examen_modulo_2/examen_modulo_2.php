...
$idExamen = 2; // Examen del módulo 1
...
<link rel="stylesheet" href="../../assets/css/pages/modulos/modulo_2/examen_modulo_2.css?v=2.0">
<link rel="stylesheet" href="../../assets/fonts/font.css?v=1.0">
<title>DevOps - Examen del Módulo 2</title>
</head>
<body>
    <header>
        <div class="logo">
        ...
        <nav>
            <ul><!--<a class="botones-cabecera" href="../../pages/modulos/modulo_1/modulo_1_introduccion.php">Introduccion Modulo 1</a>-->
                <li>
                    <form action="../../pages/modulos/modulo_2/modulo_2_introduccion.php" method="POST" onsubmit="return confirm('¿Estas seguro que quieres salir del examen?, si sales perderas tus respuestas.');">
                        <button class="botones" type="submit">Introduccion Modulo 2</button>
                    </form>
                </li>
                <li>
                    <form action="../../pages/modulos/modulo_2/panel_de_estudio_2.html" method="POST" onsubmit="return confirm('¿Estas seguro que quieres salir del examen?, si sales perderas tus respuestas.');">
...
<div class="contenedor-abuelo">
    <div class="contenedor-padre">
        <div class="contenedor-hijo">
            <div class="examen">
                <form id="form_examen" action="procesar_examen_2.php" method="POST">
    ...
    <script src="../../assets/js/modulo_2/validar_examen/validar_examen_2.js?v=1.0"></script>
</body>
</html>
