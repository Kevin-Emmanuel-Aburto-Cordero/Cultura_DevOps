...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/pages/modulos/modulo_3/resultados_3.css?v=0.0">
    <link rel="stylesheet" href="../../assets/fonts/font.css?v=1.0">
    <title>DevOps - Resultados del Examen 3</title>
</head>
<body>
        ...
        <div class="contenedor-bipadre">
            <div class="contenedor-bihijo">
                <div class="datos_unidad">
                    ...
                    ?>
                    <?php include("scripts_examen_3/mostrar_resultados_3.php"); ?>
                    <a href="examen_modulo_3.php">
                        <button class="botones" type="submit">Realizar de nuevo el examen</button>
                    </a><br>
                    <a href="../../pages/modulos/modulo_3/panel_de_estudio_3.html">
