...
$idExamen = 5; // Examen del módulo 1
...
<link rel="stylesheet" href="../../assets/css/pages/modulos/modulo_5/examen_modulo_5.css?v=1.0">
...
<body>
    <header>
        ...
        <nav>
            <ul>
                <li>
                    <form action="../../pages/modulos/modulo_5/modulo_5_introduccion.php" method="POST" onsubmit="return confirm('¿Estas seguro que quieres salir del examen?, si sales perderas tus respuestas.');">
                        <button class="botones" type="submit">Introduccion Modulo 5</button>
                    </form>
                </li>
                <li>
                    <form action="../../pages/modulos/modulo_5/panel_de_estudio_5.html" method="POST" onsubmit="return confirm('¿Estas seguro que quieres salir del examen?, si sales perderas tus respuestas.');">
...
<div class="contenedor-abuelo">
    <div class="contenedor-padre">
        <div class="contenedor-hijo">
            <div class="examen">
                <form id="form_examen" action="procesar_examen_5.php" method="POST">
    ...
    <script src="../../assets/js/modulo_5/validar_examen/validar_examen_5.js?v=1.0"></script>
</body>
</html>
