...
$idExamen = 4; // Examen del módulo 1
...
<link rel="stylesheet" href="../../assets/css/pages/modulos/modulo_4/examen_modulo_4.css?v=1.0">
<link rel="stylesheet" href="../../assets/fonts/font.css?v=1.0">
<title>DevOps - Examen del Módulo 4</title>
</head>
<body>
    <header>
        <div class="logo">
        ...
        <nav>
            <ul><!--<a class="botones-cabecera" href="../../pages/modulos/modulo_1/modulo_1_introduccion.php">Introduccion Modulo 1</a>-->
                <li>
                    <form action="../../pages/modulos/modulo_4/modulo_4_introduccion.php" method="POST" onsubmit="return confirm('¿Estas seguro que quieres salir del examen?, si sales perderas tus respuestas.');">
                        <button class="botones" type="submit">Introduccion Modulo 4</button>
                    </form>
                </li>
                <li>
                    <form action="../../pages/modulos/modulo_4/panel_de_estudio_4.html" method="POST" onsubmit="return confirm('¿Estas seguro que quieres salir del examen?, si sales perderas tus respuestas.');">
...
<div class="contenedor-abuelo">
    <div class="contenedor-padre">
        <div class="contenedor-hijo">
            <div class="examen">
                <form id="form_examen" action="procesar_examen_4.php" method="POST">
    ...
    <script src="../../assets/js/modulo_4/validar_examen/validar_examen_4.js?v=1.0"></script>
</body>
</html>
