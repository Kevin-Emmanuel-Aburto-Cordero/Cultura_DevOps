...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/pages/modulos/modulo_1/resultados_1.css?v=3.0">
    <link rel="stylesheet" href="../../assets/fonts/font.css?v=1.0">
    <title>DevOps - Resultados del Examen 1</title>
</head>
<body>
        ...
        <div class="contenedor-bipadre">
            <div class="contenedor-bihijo">
                <div class="datos_unidad">
                    ...
                    ?>
                    <?php include("scripts_examen_1/mostrar_resultados_1.php"); ?>
                    <a href="examen_modulo_1.php">
                        <button class="botones" type="submit">Realizar de nuevo el examen</button>
                    </a><br>
                    <a href="../../pages/modulos/modulo_1/panel_de_estudio_1.html">
