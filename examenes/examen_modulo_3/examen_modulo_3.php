...
$idExamen = 3; // Examen del módulo 1
...
<link rel="stylesheet" href="../../assets/css/pages/modulos/modulo_3/examen_modulo_3.css?v=3.0">
<link rel="stylesheet" href="../../assets/fonts/font.css?v=1.0">
<title>Examen del Módulo 3</title>
</head>
<body>
    <header>
        <div class="logo">
        ...
        <nav>
            <ul><!--<a class="botones-cabecera" href="../../pages/modulos/modulo_1/modulo_1_introduccion.php">Introduccion Modulo 1</a>-->
                <li>
                    <form action="../../pages/modulos/modulo_3/modulo_3_introduccion.php" method="POST" onsubmit="return confirm('¿Estas seguro que quieres salir del examen?, si sales perderas tus respuestas.');">
                        <button class="botones" type="submit">Introduccion Modulo 3</button>
                    </form>
                </li>
                <li>
                    <form action="../../pages/modulos/modulo_3/panel_de_estudio_3.html" method="POST" onsubmit="return confirm('¿Estas seguro que quieres salir del examen?, si sales perderas tus respuestas.');">
...
<div class="contenedor-abuelo">
    <div class="contenedor-padre">
        <div class="contenedor-hijo">
            <div class="examen">
                <form id="form_examen" action="procesar_examen_3.php" method="POST">
