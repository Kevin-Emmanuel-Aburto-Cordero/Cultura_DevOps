...
$idExamen = 1; // Examen del módulo 1
...
<link rel="stylesheet" href="../../assets/css/pages/modulos/modulo_1/examen_modulo_1.css?v=4.0">
<link rel="stylesheet" href="../../assets/fonts/font.css?v=1.0">
<title>DevOps - Examen del Módulo 1</title>
</head>
<body>
    <header>
        <div class="logo">
        ...
        <nav>
            <ul><!--<a class="botones-cabecera" href="../../pages/modulos/modulo_1/modulo_1_introduccion.php">Introduccion Modulo 1</a>-->
                <li>
                    <form action="../../pages/modulos/modulo_1/modulo_1_introduccion.php" method="POST" onsubmit="return confirm('¿Estas seguro que quieres salir del examen?, si sales perderas tus respuestas.');">
                        <button class="botones" type="submit">Introduccion Modulo 1</button>
                    </form>
                </li>
                <li>
                    <form action="../../pages/modulos/modulo_1/panel_de_estudio_1.html" method="POST" onsubmit="return confirm('¿Estas seguro que quieres salir del examen?, si sales perderas tus respuestas.');">
...
<div class="contenedor-abuelo">
    <div class="contenedor-padre">
        <div class="contenedor-hijo">
            <div class="examen">
                <form id="form_examen" action="procesar_examen_1.php" method="POST">
    ...
    <script src="../../assets/js/modulo_1/validar_examen_1.js?v=5.0"></script>
</body>
</html>
