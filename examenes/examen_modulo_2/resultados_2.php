...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/pages/modulos/modulo_2/resultados_2.css?v=1.0">
    <link rel="stylesheet" href="../../assets/fonts/font.css?v=1.0">
    <title>DevOps - Resultados del Examen 2</title>
</head>
<body>
        ...
        <div class="contenedor-bipadre">
            <div class="contenedor-bihijo">
                <div class="datos_unidad">
                    ...
                    ?>
                    <?php include("scripts_examen_2/mostrar_resultados_2.php"); ?>
                    <a href="examen_modulo_2.php">
                        <button class="botones" type="submit">Realizar de nuevo el examen</button>
                    </a><br>
                    <a href="../../pages/modulos/modulo_2/panel_de_estudio_2.html">
