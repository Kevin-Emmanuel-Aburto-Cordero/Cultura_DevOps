...
$idExamen = 7; // Examen del módulo 1
...
<link rel="stylesheet" href="../../assets/css/pages/modulos/modulo_7/examen_modulo_7.css?v=1.0">
<link rel="stylesheet" href="../../assets/fonts/font.css?v=1.0">
<title>DevOps - Examen del Módulo 7</title>
</head>
<body>
    <header>
        <div class="logo">
        ...
        <nav>
            <ul>
                <li>
                    <form action="../../pages/modulos/modulo_7/modulo_7_introduccion.php" method="POST" onsubmit="return confirm('¿Estas seguro que quieres salir del examen?, si sales perderas tus respuestas.');">
                        <button class="botones" type="submit">Introduccion Modulo 7</button>
                    </form>
                </li>
                <li>
                    <form action="../../pages/modulos/modulo_7/panel_de_estudio_7.html" method="POST" onsubmit="return confirm('¿Estas seguro que quieres salir del examen?, si sales perderas tus respuestas.');">
...
<div class="contenedor-abuelo">
    <div class="contenedor-padre">
        <div class="contenedor-hijo">
            <div class="examen">
                <form id="form_examen" action="procesar_examen_7.php" method="POST">
    ...
    <script src="../../assets/js/modulo_7/validar_examen/validar_examen_7.js?v=1.0"></script>
</body>
</html>
