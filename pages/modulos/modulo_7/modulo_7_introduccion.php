<?php 
include("scripts_modulo_7/verificar_modulo.php");
?>
<!DOCTYPE html>
<html lang="es-ES">
<head>
    ...
    <link rel="stylesheet" href="../../../assets/css/pages/modulos/modulo_7/modulo_7_introduccion.css?=2.0">
    <link rel="stylesheet" href="../../../assets/fonts/font.css?=1.0">
    <title>DevOps - Módulo 7</title>
</head>
<body>
    <header>
        <div class="logo">
    ...
    <div class="contenedor-abuelo">
        <div class="contenedor-padre">
            <div class="info_modulo">
                ...
                <?php include("scripts_modulo_7/mostrar_datos_modulo_7.php"); ?>
            </div>
        </div>
    </div>
    <div class="subtitulo">
    ...
    <div class="contenedor-abuela">
        <div class="contenedor-madre">
            ...
            <button class="botones" id="btnExamen">
                <b>Examen</b><br>
                <img class="bangbus" src="../../../assets/img/bangbus_zzz/Sharkboo_Portrait.webp" alt="Base_Bangboo">
            </button>
            <p id="mensaje" style="color : white;"></p>
            <script src="../../../assets/js/modulo_7/actividades_terminadas_modulo_7/actividades_terminadas_modulo_7.js?v=1.0"></script>
            <script src="../../../assets/js/modulo_7/verificar_actividad_terminada/verificar_actividad_terminada_leccion_2.js?v=1.0"></script>
            <script src="../../../assets/js/modulo_7/verificar_actividad_terminada/verificar_actividad_terminada_leccion_3.js?v=1.0"></script>
            <script src="../../../assets/js/modulo_7/verificar_actividad_terminada/verificar_actividad_terminada_leccion_4.js?v=1.0"></script>
        </div>
    </div>
</body>
</html>