...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/pages/modulos/modulo_6/resultados_6.css?v=1.0">
    <link rel="stylesheet" href="../../assets/fonts/font.css?v=1.0">
    <title>DevOps - Resultados del Examen 6</title>
</head>
<body>
        ...
        <div class="contenedor-bipadre">
            <div class="contenedor-bihijo">
                <div class="datos_unidad">
                    ...
                    ?>
                    <?php include("scripts_examen_6/mostrar_resultados_6.php"); ?>
                    <a href="examen_modulo_6.php">
                        <button class="botones" type="submit">Realizar de nuevo el examen</button>
                    </a><br>
                    <a href="../../pages/modulos/modulo_6/panel_de_estudio_6.html">
